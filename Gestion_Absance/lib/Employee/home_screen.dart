                          ...
                          child: Center(
                            child: Column(
                              ...
                              children: [
                                  ...
                                  child: ClipOval(
                                    child: Container(
                                      child: SizedBox(
                                          width: 180,
                                          height: 180,
                                          child: checkprofile((document.data()
                                ...
                                Container(
                                  child: Text(
                                    "Bienvenue ${(document.data() as Map<String, dynamic>)['Fullname'] as String?}",
                                    style: TextStyle(
...
class TodaysDate extends StatefulWidget {
  ...
  late final String tdate;
  late final String cInTime;
  late final String cOutTime;
